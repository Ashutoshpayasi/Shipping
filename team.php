...
<!-- Mirrored from themehealer.com/onpoint/team.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 05:00:48 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Team || onpoint || onpoint HTML 5 Template </title>
    <!-- favicons Icons -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__content">
                                <h3 class="team-one__title"><a href="team-details.php">Adam Smith</a>
                                </h3>
                                <p class="team-one__sub-title">Efficient Transport</p>
                                <div class="team-one__social">
                                    <a href="#"><span class="icon-instagram"></span></a>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__content">
                                <h3 class="team-one__title"><a href="team-details.php">Asle Brown</a>
                                </h3>
                                <p class="team-one__sub-title">Efficient Transport</p>
                                <div class="team-one__social">
                                    <a href="#"><span class="icon-instagram"></span></a>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__content">
                                <h3 class="team-one__title"><a href="team-details.php">James Andarson</a>
                                </h3>
                                <p class="team-one__sub-title">Efficient Transport</p>
                                <div class="team-one__social">
                                    <a href="#"><span class="icon-instagram"></span></a>
...
<!-- Mirrored from themehealer.com/onpoint/team.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 05:00:51 GMT -->
</html>