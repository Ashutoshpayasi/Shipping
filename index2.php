...
<!-- Mirrored from themehealer.com/onpoint/index2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 05:00:28 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Home Two || onpoint || onpoint HTML 5 Template </title>
    <!-- favicons Icons -->
...
<body>
    ...
    <div class="page-wrapper">
                        ...
                        <div class="main-menu-two__wrapper-inner">
                            <div class="main-menu-two__left">
                                <div class="main-menu-two__logo">
                                    <a href="index-2.php"><img src="assets/images/resources/logo-2.png" alt=""></a>
                                </div>
                                    ...
                                    <ul class="main-menu__list">
                                        <li class="dropdown">
                                            ...
                                            <ul>
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul>
                                                        <li><a href="index-2.php">Header One</a></li>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="services-carousel.php">Services Carousel</a></li>
                                                <li><a href="express-freight-solutions.php">Express Freight
                                                        Solutions</a></li>
                                                <li><a href="quick-move-logistics.php">Quick Move Logistics</a></li>
                                                <li><a href="speedy-dispatch.php">Speedy Dispatch</a></li>
                                                <li><a href="swift-supply-chain.php">Swift Supply Chain</a></li>
                                                <li><a href="on-point-distribution.php">On Point Distribution</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
                                            <a href="#">Projects</a>
                            ...
                            <div class="main-menu-two__right">
                                <div class="main-menu-two__call-and-btn-box">
                                    ...
                                    <div class="main-menu-two__btn-box">
                                        <a href="about.php" class="thm-btn main-menu-two__btn">Read
                                            more<span></span></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="banner-one__left wow fadeInLeft" data-wow-delay="300ms">
                            <div class="banner-one__sub-title-box">
                                <div class="banner-one__sub-title-icon">
                                    <img src="assets/images/icon/banner-one-sub-title-icon.png" alt="">
                                </div>
                                <h5 class="banner-one__sub-title">Best Cargo</h5>
                            </div>
                            <h2 class="banner-one__title">Transport Goods <br> Priority <span>Logistics <br>
                                    Simplified</span></h2>
                            <div class="banner-one__btn-box">
                                <a href="about.php" class="thm-btn banner-one__btn">Read more<span></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5">
                        <div class="banner-one__right wow fadeInRight" data-wow-delay="400ms">
                            <div class="banner-one__img-box">
                                ...
                                <div class="banner-one__content">
                                    <div class="banner-one__call">
                                        ...
                                        <div class="banner-one__call-number">
                                            <p>Need help?</p>
                                            <h5><a href="tel:307555-0133">(307) 555-0133</a></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="banner-one__img-two">
        ...
        <section class="services-two">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2 class="section-title__title">Your supply chain partner<br> the for success</h2>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInLeft" data-wow-delay="100ms">
                        <div class="services-two__single">
                            ...
                            <h3 class="services-two__title"><a href="express-freight-solutions.php">Fast and reliable
                                    logistics
                                    the solutions</a></h3>
                            <p class="services-two__text">Logistic service involves of implementation and control of the
                                efficient</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="services-two__single">
                            ...
                            <h3 class="services-two__title"><a href="speedy-dispatch.php">Bridges Construction is an
                                    essen industry</a></h3>
                            <p class="services-two__text">Logistic service involves of implementation and control of the
                                efficient</p>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInRight" data-wow-delay="300ms">
                        <div class="services-two__single">
                            ...
                            <h3 class="services-two__title"><a href="quick-move-logistics.php"> That involves building
                                    adesig the a structures</a></h3>
                            <p class="services-two__text">Logistic service involves of implementation and control of the
                                efficient</p>
                        </div>
                    </div>
        ...
        <section class="why-choose-two">
            <div class="why-choose-two__bg"
                style="background-image: url(assets/images/backgrounds/why-choose-two-bg.jpg);">
                <div class="why-choose-two__need-help">
                    <div class="icon">
                        <span class="icon-phone"></span>
                    </div>
                    <div class="content">
                        <p>Need help?</p>
                        <h3><a href="tel:01925836974">01925836974</a></h3>
                    </div>
                </div>
            </div>
            <div class="container">
                    ...
                    <div class="col-xl-6">
                        <div class="why-choose-two__left">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title">Delivering excellence<br> every a time Express<br>
                                    Logistics
                                </h2>
                            </div>
                            <p class="why-choose-two__text">Construction is an essential industry that involves
                                building<br>
                                adesigning the an structures such as buildings roads, bridges <br>Construction is an
                                essent
                                industry that involves building<br> adesigning the a structures such </p>
                            <div class="why-choose-two__btn-box">
                                <a href="about.php" class="thm-btn why-choose-two__btn">Read more<span></span></a>
                            </div>
        ...
        <section class="counter-two">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7">
                        <div class="counter-two__left wow slideInLeft" data-wow-delay="100ms"
                    ...
                    <div class="col-xl-5">
                        <div class="counter-two__right">
                            <div class="counter-two__big-text">
                                <h3>Since 1920</h3>
                            </div>
                                ...
                                <ul class="counter-two__count-list list-unstyled">
                                    <li>
                                        <div class="counter-two__count-list-single">
                                            ...
                                            <p class="counter-two__count-text">Our Happy Customer</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="counter-two__count-list-single">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-two__single">
                                    ...
                                    <h3 class="testimonial-two__client-name">Sakib Hasan</h3>
                                    <p class="testimonial-two__sub-title">Developer</p>
                                    <p class="testimonial-two__text">This category Dantal his category Danta Their
                                        product exceeded expectationsa a quality a attention to moutstandin an and it
                                        has essential most design man Billboard advertising is a power marketing tool
                                        that he businesBillboard advertising is a powerful marketing tool business and
                                        reach their target audienceses gain </p>
                            ...
                            <div class="blog-two__content-inner">
                                <div class="blog-two__content">
                                    <ul class="blog-two__meta list-unstyled">
                                        <li>
                                            <a href="blog-details.php"><span class="icon-user"></span>By admin</a>
                                        </li>
                                        <li>
                                            <a href="blog-details.php"><span class="icon-comments"></span>Comments
                                                (05)</a>
                                        </li>
                                    </ul>
                                    <h3 class="blog-two__title"><a href="blog-details.php">Your trusted the provider
                                            Express Logistics</a></h3>
                                </div>
                                <div class="blog-two__btn-box">
                                    <a href="blog-details.php" class="thm-btn blog-two__btn">Read more<span></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="blog-two__single">
                            ...
                            <div class="blog-two__content-inner">
                                <div class="blog-two__content">
                                    ...
                                    <h3 class="blog-two__title"><a href="blog-details.php">Delivering success through
                                            logistics Logistics</a></h3>
                                </div>
                                <div class="blog-two__btn-box">
                                    <a href="blog-details.php" class="thm-btn blog-two__btn">Read more<span></span></a>
                                </div>
                        ...
                        <div class="blog-two__single">
                            ...
                            <div class="blog-two__content-inner">
                                <div class="blog-two__content">
                                    ...
                                    <h3 class="blog-two__title"><a href="blog-details.php">Streamlining your supply
                                            Your provider</a></h3>
                                </div>
                                <div class="blog-two__btn-box">
                                    <a href="blog-details.php" class="thm-btn blog-two__btn">Read more<span></span></a>
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="site-footer-two__top-left">
                                <h3 class="site-footer-two__top-title">Have a <span>project</span> in mind?</h3>
                            </div>
                        </div>
                        <div class="col-xl-8">
                            <div class="site-footer-two__top-right">
                                <form class="footer-widget-two__newsletter-form mc-form" data-url="MC_FORM_URL"
                                    ...
                                    <div class="footer-widget-two__newsletter-form-input-box">
                                        ...
                                        <button type="submit"
                                            class="footer-widget-two__newsletter-btn thm-btn">Subscribe
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="footer-widget-two__column footer-widget-two__about">
                                <div class="footer-widget-two__logo">
                                    <a href="index-2.php"><img src="assets/images/resources/footer-logo-2.png"
                                            alt=""></a>
                                </div>
                                <p class="footer-widget-two__text">It is a long established fact that a reader<br>
                                    will
                                    be distracted Empowering </p>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="footer-widget__column footer-widget-two__services">
                                ...
                                <ul class="footer-widget-two__services-list list-unstyled">
                                    <li>
                                        <a href="express-freight-solutions.php"><span
                                                class="icon-angle-left"></span>Express Freight
                                            Solutions</a>
                                    </li>
                                    <li>
                                        <a href="quick-move-logistics.php"><span class="icon-angle-left"></span>Rapid
                                            Delivery
                                            Services</a>
                                    </li>
                                    <li>
                                        <a href="speedy-dispatch.php"><span class="icon-angle-left"></span>Speedy
                                            Haulage</a>
                                    </li>
                                    <li>
                                        <a href="on-point-distribution.php"><span
                                                class="icon-angle-left"></span>Reliable
                                            Transporters</a>
                                    </li>
                                    <li>
                                        <a href="swift-supply-chain.php"><span class="icon-angle-left"></span>Swift
                                            Ship
                                            Solutions</a>
                                    </li>
                                </ul>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index-2.php" aria-label="logo image"><img src="assets/images/resources/logo-2.png" width="150"
                        alt="" /></a>
            </div>
            <!-- /.logo-box -->
...
<!-- Mirrored from themehealer.com/onpoint/index2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 05:00:47 GMT -->
</html>