        ...
        <section class="services-one">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2 class="section-title__title">HONDURAS COC DECK & ENGINE SIDE RENEWAL (Operational & Management Level)</h2>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="why-choose-one__left">
                            ...
                            <ul>
                                ...
                                <li>Must use “Honduras” Medical Form.</li>
                                ...
                                <br>
                            <p><strong>PROCESSING TIME:</strong> 7 DAYS</p>
                        </div>
                    </div>
