...
<head>
    ...
    <title> Sea Fright Service </title>
    <!-- favicons Icons -->
        ...
        <section class="services-one">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2 class="section-title__title">Why Partner with Us <br>For Your Sea Freight Services?</h2>
                </div>
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="why-choose-one__left">
                            ...
                            <p class="why-choose-one__text" style="text-align: justify;">Sea freight services are an essential component of global trade, offering a cost-effective and efficient means of transporting large volumes of goods across international waters.
                                These services are designed to handle various types of cargo, including bulk commodities, containerized goods, and oversized items,
                                ensuring they reach their destinations safely and on time. </p>
                            <p class="why-choose-one__text" style="text-align: justify;">The reliability and scalability of sea freight make it a preferred choice for businesses looking to expand their reach and optimize
                                their supply chains. By leveraging advanced tracking technologies and robust partnerships with
                                shipping lines, sea freight services offer unmatched flexibility and control, ensuring seamless delivery and customer satisfaction. </p>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="services-details__left">
                            ...
                            <div class="services-details__get-touch">
                                <div class="services-details__get-touch-bg" style="background-image: url();">
                                </div>
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="services-details__right">
                            <h3 class="services-details__title-1">Cultivate Success with Sreyasi Marine</h3>
                                ...
                                <div class="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-1">
                                    <div class="accrodion active">
                                        ...
                                        <div class="accrodion-title">
                                            <h4>What shipping logistics services do you offer?</h4>
                                        </div>
                                        <div class="accrodion-content">
                                            <div class="inner">
                                                <p>We specialize in sea freight services only. Our logistics solutions are tailored to ensure efficient and reliable shipping via sea routes, catering to various cargo sizes and requirements.</p>
                                            </div><!-- /.inner -->
                                        </div>
                                    </div>
                                    <div class="accrodion">
                                        <div class="accrodion-count"></div>
                                        <div class="accrodion-title">
                                            <h4>How can ProActive Transport benefit my shipping needs?</h4>
                                        </div>
                                        <div class="accrodion-content">
                                            <div class="inner">
                                                <p>ProActive Transport offers proactive solutions for your sea freight needs, ensuring timely delivery, cost-effectiveness, and reliable handling of your cargo throughout the shipping process.</p>
                                            </div><!-- /.inner -->
                                        </div>
                                    </div>
                                    <div class="accrodion">
                                        <div class="accrodion-count"></div>
                                        <div class="accrodion-title">
                                            <h4>What are the advantages of Swift Warehousing Solutions in sea freight?</h4>
                                        </div>
                                        <div class="accrodion-content">
                                            <div class="inner">
                                                <p>Swift Warehousing Solutions provide efficient storage and handling of sea freight cargo, optimizing logistics operations and ensuring seamless transitions between shipping and storage phases.</p>
                                            </div><!-- /.inner -->
                                        </div>
                                    </div>
                                    <div class="accrodion">
                                        <div class="accrodion-count"></div>
                                        <div class="accrodion-title">
                                            <h4>How do Efficient Freight Solutions enhance sea freight services?</h4>
                                        </div>
                                        <div class="accrodion-content">
                                            <div class="inner">
                                                <p>Efficient Freight Solutions streamline sea freight processes, offering innovative logistics solutions that reduce costs, improve delivery times, and ensure the safe transport of cargo via sea routes.</p>
                                            </div><!-- /.inner -->
                                        </div>
                                    </div>
                                </div>
