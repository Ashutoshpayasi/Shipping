...
<!-- Mirrored from themehealer.com/onpoint/services-carousel.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 05:00:53 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Services Carousel || onpoint || onpoint HTML 5 Template </title>
    <!-- favicons Icons -->
                ...
                <div class="team-carousel thm-owl__carousel owl-theme owl-carousel carousel-dot-style" data-owl-options='{
                    ...
                    <div class="item">
                        <div class="services-one__single">
                            ...
                            <h3 class="services-one__title"><a href="swift-supply-chain.php">Logistics expertise for
                                    your
                                    competitive advantage</a></h3>
                            <div class="services-one__btn-box">
                                <a href="swift-supply-chain.php" class="thm-btn services-one__btn">Read
                                    more<span></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="services-one__single">
                            ...
                            <h3 class="services-one__title"><a href="on-point-distribution.php">Delivering success
                                    through
                                    the logistics
                                </a></h3>
                            <div class="services-one__btn-box">
                                <a href="on-point-distribution.php" class="thm-btn services-one__btn">Read
                                    more<span></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="services-one__single">
                            ...
                            <h3 class="services-one__title"><a href="express-freight-solutions.php">Simplifying your
                                    logistics
                                    the challenges</a></h3>
                            <div class="services-one__btn-box">
                                <a href="express-freight-solutions.php" class="thm-btn services-one__btn">Read
                    ...
                    <div class="item">
                        <div class="services-one__single">
                            ...
                            <h3 class="services-one__title"><a href="quick-move-logistics.php">Efficiency at its best,
                                    with
                                    our logistics services</a></h3>
                            <div class="services-one__btn-box">
                                <a href="quick-move-logistics.php" class="thm-btn services-one__btn">Read
                                    more<span></span></a>
                            </div>
                    ...
                    <div class="item">
                        <div class="services-one__single">
                            ...
                            <h3 class="services-one__title"><a href="speedy-dispatch.php">Seamless logistics for your
                                    business needs</a></h3>
                            <div class="services-one__btn-box">
                                <a href="speedy-dispatch.php" class="thm-btn services-one__btn">Read
                                    more<span></span></a>
                    ...
                    <div class="item">
                        <div class="services-one__single">
                            ...
                            <h3 class="services-one__title"><a href="swift-supply-chain.php">Your supply chain partner
                                    for
                                    the success</a></h3>
                            <div class="services-one__btn-box">
                                <a href="swift-supply-chain.php" class="thm-btn services-one__btn">Read
