...
<body>
    ...
    <div class="page-wrapper">
        ...
        <style>
            ...
            .requirements-list li:nth-child(even) {
        ...
        <section class="services-one">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2 class="section-title__title">LIBERIA COC/COE on <br> Nationalise Certificate of Competency</h2>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="why-choose-one__left">
                            ...
                            <ul class="requirements-list">
                                ...
                                <li>Must use “Liberian” Medical Form.</li>
                                <li>Basic STCW & Advance courses, GMDSS, ROC and ARPA, SSO etc.</li>
                                <li>Copy of Valid Seaman book</li>
                                <li>Certificate of Competency</li>
                                <li>Copy of valid Company experience certificates, etc</li>
                            </ul>
                            <br>
                            <p>PROCESSING TIME – 20 DAYS</p>
                            <p>Call now on <span style="color:black">+91 9910302896 </span>or send scanned documents</p>
