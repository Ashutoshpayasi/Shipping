...
<!-- Mirrored from themehealer.com/onpoint/404.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 05:00:52 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> 404 Error || onpoint || onpoint HTML 5 Template </title>
    <!-- favicons Icons -->
    ...
    <div class="page-wrapper">
        ...
        <section class="error-page">
            <div class="error-page-shape-one float-bob-x">
                <img src="assets/images/shapes/error-page-shape-1.php" alt="">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="error-page__inner">
                            ...
                            <a href="index-2.php" class="thm-btn error-page__btn">Back to home <span></span></a>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from themehealer.com/onpoint/404.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 05:00:53 GMT -->
</html>