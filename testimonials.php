...
<!-- Mirrored from themehealer.com/onpoint/testimonials.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 05:00:52 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Testimonials || onpoint || onpoint HTML 5 Template </title>
    <!-- favicons Icons -->
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="testimonials-page">
            <div class="container">
                <div class="row">
                    <!--Testimonials Page Single Start-->
