                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="project-details__left">
                                ...
                                <ul class="project-details__information-list list-unstyled">
                                    ...
                                    <li>
                                        ...
                                        <p><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i
                                                class="icon-star"></i><i class="icon-star last-icon"></i>
                                        </p>
                                    </li>
                                </ul>
                            ...
                            <ul class="project-details__contact-list list-unstyled">
                                <li>
                                    <div class="icon">
                                        <span class="icon-location icon-1"></span>
                                    </div>
                                    <div class="content">
                                        <h3>Address</h3>
                                ...
                                <li>
                                    <div class="icon">
                                        <span class="icon-call icon-2"></span>
                                    </div>
                                    <div class="content">
                                        <h3>Lets Talk us</h3>
                                ...
                                <li>
                                    <div class="icon">
                                        <span class="icon-envolop icon-3"></span>
                                    </div>
                                    <div class="content">
                                        <h3>Send us email</h3>
                                        <p><a href="mailto:nafiz1223@gmail.com">nafiz1223@gmail.com</a>
                                            <a href="nafiz1223%40gmail.php"> fahad
                                                <br> demo23yourmail.com</a></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-xl-8">
                        <div class="project-details__right">
                            ...
                            <h3 class="project-details__title-1">Cultivate Success with Agriculture</h3>
                            <p class="project-details__text-1">Logistics service involves the planning, implementation,
                                and control of the efficient and effective transportation, storage, and distribution of
                                goods and materials Logistics service involves the planning</p>
                            <p class="project-details__text-2">Logistics service involves the planning, implementation,
                                and control of the efficient and effective transportation, storage, and distribution of
                            ...
                            <ul class="project-details__points list-unstyled">
                                <li>
                                    ...
                                    <p>Trust us for reliable and cost-effective logistics solutions</p>
                                </li>
                                <li>
                                    <div class="icon">
                                        <span class="icon-dabble-arrow"></span>
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="project-details__img-box-img">
                                            <img src="assets/images/project/project-details-img-box-img-1.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="project-details__img-box-img">
                                            <img src="assets/images/project/project-details-img-box-img-2.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <p class="project-details__text-3">Logistics service involves the planning, implementation,
                                and control of the efficient and effective transportation, storage, and distribution of
                                goods and materials Logistics service involves the planning</p>
                        </div>
                    </div>
