        ...
        <section class="services-one">
            <div class="container">
                <div class="section-title text-center">
                    <h2 class="section-title__title">PANAMA COC DECK & ENGINE SIDE UPGRADATION (Operational & Management  Level)</h2>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="why-choose-one__left">
                            ...
                            <ul >
                                ...
                                <li>Must use “PANAMA” Medical Form.</li>
                            ...
                            <h3>Contact Us</h3>
                            <p>Call now on 09997973040 for best price.</p>
